<script lang="ts">
  import {Component, Emit, Prop, Vue} from 'nuxt-property-decorator';
    ...
    //TODO: Use VueTinySlider from the fork i've created for easier updating and maintaince
  ...
  @Component({
    ...
    export default class Slider extends Vue {
        ...
        @Prop({type:Number,default: 0}) lazyloadOffset;
        ...
        @Prop({type:Boolean,default: false}) hideHeader;
    ...
    <div
      ...
      <div class="tiny-slider__header__left">
        ...
        <router-link v-if="more_link_text !== ''"
                     class="btn btn--secondary--outline btn--sm tiny-slider__more-btn"
      ...
      <div class="tiny-slider__navigation"
        ...
        <button class="btn btn--icon btn--xsm tiny-slider__navigation__arrow--left tiny-slider__navigation__arrow"
                role="button"
                v-if="mode === 'carousel'">
          <sk-icon :type="'arrow_left'"></sk-icon>
        </button>
