<script lang="ts">
    ...
    export default class Slide extends Vue {
        ...
        beforeMount(){
            this.ie_src = getIESrc(this.region.image.srcset,1920);
        }
    }
</script>
...
<template>
    <div class="tiny-slider__slide">
      <slide-link :item="region" class="tiny-slider__link">
        <div class="tiny-slider__slide__inner">
          <div class="tiny-slider__slide__background">
            <div class="tiny-slider__slide__background-inner">
              <img class="img-fluid tns-lazy-img"
                   :alt="region.name"
                   :src="region.image.base64"
                   :data-src="ie_src"
                   :data-srcset="region.image.srcset"
          ...
          <div class="tiny-slider__slide__content">
            <h2 class="tiny-slider__slide__title">{{ region.name }}</h2>
            <p class="tiny-slider__slide__description">{{ region.short }}</p>
            <slide-link :item="region" class="tiny-slider__link">
